...
app.use((req, res, next) => {
  res.setHeader("Cross-Origin-Opener-Policy", "unsafe-none"); //  `window.postMessage` 허용
...
app.use(
  helmet({
    crossOriginOpenerPolicy: { policy: "unsafe-none" }, //  COOP 완화
    crossOriginEmbedderPolicy: false, // CEOP 해제
  })
);
